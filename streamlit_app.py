...
from pages import games_analysis, network_analysis, player_performance_prediction, clustering # import your pages here
...
app.add_page("Games Analysis", games_analysis.app)
